...
export const metadata: Metadata = {
  title: "Design System Specification | Siddharth Varpe",
  robots: {
    index: false,
    follow: false,
    nocache: true,
...
/**
 * Phase 2 Design System Verification View (Isolated Development Showcase).
    ...
    <main className="py-12 sm:py-16 bg-grid-technical min-h-screen">
      <Container size="public" className="space-y-16">
        ...
        <div className="space-y-4 border-b border-border pb-8">
          <TechnicalLabel>Internal Verification — Design System & Visual Foundation</TechnicalLabel>
        ...
        <section aria-labelledby="typography-heading" className="space-y-6">
          ...
          <div className="rounded-lg border border-border bg-surface p-6 space-y-4">
            ...
            <div>
              ...
              <CardTitle className="mt-1">Design System Primitive</CardTitle>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="mt-1">
                <MonoText>SYS_TOKEN: GEIST_MONO_400 | TRACKING: TIGHT | SPEC: TOKENS_V2</MonoText>
              </p>
            </div>
          </div>
        </section>
        ...
        <section aria-labelledby="interactive-heading" className="space-y-6">
          ...
          <div className="rounded-lg border border-border bg-surface p-6 space-y-6">
            ...
            <div className="flex flex-wrap gap-6 pt-4 border-t border-border/50 text-sm">
              ...
              <Link href="/admin/login" variant="accent">Admin Access</Link>
              <Link href="/api/resume/download" isExternal showExternalIcon variant="subtle">
                Active Resume PDF
              </Link>
            </div>
          </div>
        ...
        {/* 3. Metric Component Demonstration */}
        <section aria-labelledby="metrics-heading" className="space-y-6">
          <SectionHeader
            eyebrow="Evidence"
            title="Metric Presentation Primitives"
            description="Reusable numeric presentation primitives designed for verified project data."
          />
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
            <Metric
              value="01"
              label="Numeric Primitive"
              description="Headline metric scale demonstration."
            />
            <Metric
              value="02"
              label="Monospace Alignment"
              description="Sub-header metric alignment demonstration."
            />
            <Metric
              value="03"
              label="Tabular Layout"
              description="Grid-responsive metric container demonstration."
            />
          </div>
        </section>
